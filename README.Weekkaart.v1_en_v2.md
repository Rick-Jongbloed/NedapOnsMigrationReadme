# **README – Nedap Ons API Endpoint Migratie (Weekkaart Connector)**

Deze README beschrijft de wijzigingen die nodig zijn om de **Weekkaart connector**
te upgraden naar de **Nedap Ons v0 API-endpoints**.

Alle wijzigingen gelden voor zowel de **HelloID PowerShell v1** als **PowerShell v2**
connectorversies.
...
## **1.1 weekkaart-account-create.ps1**  
...
## **1.2 weekkaart-account-update.ps1**  
*(HelloID PowerShell v1 en v2)*
...
* **Test de Weekkaart connector via de business rule logica met een testmedewerker**:
  - account create  
  - account update  
  - (indien van toepassing) import  

Dit bevestigt dat de Weekkaart connector de nieuwe v0-endpoints correct gebruikt.
